...
`,[R("splitor",`
 ...
 `)])]);function er(e,o,t){var r;const l=[];let s=!1;for(let d=0;d<e.length;++d){const i=e[d],b=(r=i.type)===null||r===void 0?void 0:r.name;b==="RadioButton"&&(s=!0);const h=i.props;if(b!=="RadioButton"){l.push(i);continue}if(d===0)l.push(i);else{const y=l[l.length-1].props,m=o===y.value,x=y.disabled,p=o===h.value,c=h.disabled,F=(m?2:0)+(x?0:1),$=(p?2:0)+(c?0:1),T={[`${t}-radio-group__splitor--disabled`]:x,[`${t}-radio-group__splitor--checked`]:m},S={[`${t}-radio-group__splitor--disabled`]:c,[`${t}-radio-group__splitor--checked`]:p},N=F<$?S:T;l.push(a("div",{class:[`${t}-radio-group__splitor`,N]}),i)}}return{children:l,isButtonGroup:s}}const or=Object.assign(Object.assign({},fe.props),{name:String,value:[String,Number,Boolean],defaultValue:{type:[String,Number,Boolean],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),br=de({name:"RadioGroup",props:or,setup(e){const o=M(null),{mergedSizeRef:t,mergedDisabledRef:r,nTriggerFormChange:l,nTriggerFormInput:s,nTriggerFormBlur:d,nTriggerFormFocus:i}=qe(e),{mergedClsPrefixRef:b,inlineThemeDisabled:h,mergedRtlRef:y}=we(e),m=fe("Radio","-radio-group",Qn,Lo,e,b),x=M(e.defaultValue),p=ne(e,"value"),c=$e(p,x);function F(_){const{onUpdateValue:P,"onUpdate:value":z}=e;P&&Z(P,_),z&&Z(z,_),x.value=_,l(),s()}function $(_){const{value:P}=o;P&&(P.contains(_.relatedTarget)||i())}function T(_){const{value:P}=o;P&&(P.contains(_.relatedTarget)||d())}Ue(Ko,{mergedClsPrefixRef:b,nameRef:ne(e,"name"),valueRef:c,disabledRef:r,mergedSizeRef:t,doUpdateValue:F});const S=Ee("Radio",y,b),N=E(()=>{const{value:_}=t,{common:{cubicBezierEaseInOut:P},self:{buttonBorderColor:z,buttonBorderColorActive:j,buttonBorderRadius:X,buttonBoxShadow:ee,buttonBoxShadowFocus:K,buttonBoxShadowHover:L,buttonColor:u,buttonColorActive:I,buttonTextColor:H,buttonTextColorActive:G,buttonTextColorHover:J,opacityDisabled:oe,[le("buttonHeight",_)]:q,[le("fontSize",_)]:Q}}=m.value;return{"--n-font-size":Q,"--n-bezier":P,"--n-button-border-color":z,"--n-button-border-color-active":j,"--n-button-border-radius":X,"--n-button-box-shadow":ee,"--n-button-box-shadow-focus":K,"--n-button-box-shadow-hover":L,"--n-button-color":u,"--n-button-color-active":I,"--n-button-text-color":H,"--n-button-text-color-hover":J,"--n-button-text-color-active":G,"--n-height":q,"--n-opacity-disabled":oe}}),O=h?Fe("radio-group",E(()=>t.value[0]),N,e):void 0;return{selfElRef:o,rtlEnabled:S,mergedClsPrefix:b,mergedValue:c,handleFocusout:T,handleFocusin:$,cssVars:h?void 0:N,themeClass:O==null?void 0:O.themeClass,onRender:O==null?void 0:O.onRender}},render(){var e;const{mergedValue:o,mergedClsPrefix:t,handleFocusin:r,handleFocusout:l}=this,{children:s,isButtonGroup:d}=er(Xt(an(this)),o,t);return(e=this.onRender)===null||e===void 0||e.call(this),a("div",{onFocusin:r,onFocusout:l,ref:"selfElRef",class:[`${t}-radio-group`,this.rtlEnabled&&`${t}-radio-group--rtl`,this.themeClass,d&&`${t}-radio-group--button-group`],style:this.cssVars},s)}}),tr={class:"binding-selector"},nr={class:"binding-selector-error-body"},rr=de({__name:"BindingSelector",props:{requiredPerm:{}},setup(e){const o=e,t=Jt(),r=cn(),l=E(()=>r.list.map(s=>{const d=s.anchorName?` · ${s.anchorName}`:"",i=`${s.accountName} @ ${s.roomId}${d}${s.enabled?"":"（已停用）"}`;return{label:o.requiredPerm!==void 0&&!t.hasPerm(s,o.requiredPerm)?`${i}（无 ${o.requiredPerm} 权限）`:i,value:s.id}}));return(s,d)=>(oo(),Zt("div",tr,[me(r).loading?(oo(),fo(me(sn),{key:0,size:"small"})):(oo(),fo(me(qn),{key:1,value:me(r).currentId,options:l.value,placeholder:"没有可用的直播间",style:{width:"260px"},"onUpdate:value":me(r).select},null,8,["value","options","onUpdate:value"])),me(r).loadError?(oo(),fo(me(An),{key:2,type:"error",title:"加载直播间列表失败",class:"binding-selector-error"},{default:ko(()=>[Ro("div",nr,[Ro("span",null,Qt(me(r).loadError),1),en(me(on),{size:"small",onClick:d[0]||(d[0]=i=>me(r).refresh())},{default:ko(()=>[...d[1]||(d[1]=[tn("重试",-1)])]),_:1})])]),_:1})):nn("",!0)]))}}),gr=rn(rr,[["__scopeId","data-v-2a2d8250"]]);export{ur as A,gr as B,Tn as F,qn as N,Sn as V,br as a,An as b,vr as c,hr as d,fr as e,Pn as f,Nn as g,go as m,Xn as r,Jn as s};
